#ifndef _BOMBERMAN_ENTITIES_ENEMYLOCO_H_
#define _BOMBERMAN_ENTITIES_ENEMYLOCO_H_
...
/**
    ...
    */
    ...
    /**
        ...
        *
        */
class EnemyLoco : public GameActor
{
public:
    /**
        * @brief Create EnemyLoco
        *
        */
    EnemyLoco(std::shared_ptr<SDL_Texture> texture, SDL_Renderer* renderer);
    /**
